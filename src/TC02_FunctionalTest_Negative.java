...
public class TC02_FunctionalTest_Negative {
    ...
    public void testinValidLogin() throws InterruptedException {
        ...
        public void loginInput() throws InterruptedException{
        	Thread.sleep(7000);
        	driver.findElement(By.xpath("//input[@name='email' and @placeholder='E-Mail Address']")).sendKeys("user@example.com");
        ...
        System.out.println("Test case is passing as expected, user is not able to Login. Warning message displayed");
    }
